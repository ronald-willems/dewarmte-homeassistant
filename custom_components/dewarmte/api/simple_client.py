...
class DeWarmteSimpleApiClient:
    ...
    async def get_schedule(self, device_id: str) -> Schedule | None:
        """Get device schedule.
        ...
        Returns:
            Schedule | None: Schedule if successful, None otherwise
        """
    ...
    async def get_schedule_item(
        self, device_id: str, schedule_id: str, item_id: str
    ) -> ScheduleItem | None:
        ...
        Args:
            ...
            item_id: The ID of the schedule item

        Returns:
            ScheduleItem | None: Schedule item if successful, None otherwise
        """
        return await self._make_request(
            "GET",
            f"devices/{device_id}/schedule/{schedule_id}/items/{item_id}",
            model_class=ScheduleItem,
        )

    async def create_schedule_item(
        self, device_id: str, schedule_id: str, item: dict[str, Any]
    ) -> ScheduleItem | None:
        ...
        Returns:
            ScheduleItem | None: Created schedule item if successful, None otherwise
        """
        return await self._make_request(
            "POST",
            f"devices/{device_id}/schedule/{schedule_id}/items",
            model_class=ScheduleItem,
            json_data=item,
            expected_status=201,
        )
    ...
    async def update_schedule_item(
        self, device_id: str, schedule_id: str, item_id: str, item: dict[str, Any]
    ) -> ScheduleItem | None:
        ...
        Args:
            ...
            schedule_id: The ID of the schedule
            item_id: The ID of the schedule item
            item: The updated schedule item

        Returns:
            ScheduleItem | None: Updated schedule item if successful, None otherwise
        """
        return await self._make_request(
            "PUT",
            f"devices/{device_id}/schedule/{schedule_id}/items/{item_id}",
    ...
    async def get_schedule_item_types(self) -> list[ScheduleItemType] | None:
        """Get available schedule item types.

        Returns:
            list[ScheduleItemType] | None: List of schedule item types if successful, None otherwise
        """
        return await self._make_request(
            "GET",
            "schedule-item-types",
            model_class=ScheduleItemType,
        )

    async def get_schedule_item_modes(self) -> list[ScheduleItemMode] | None:
        """Get available schedule item modes.

        Returns:
            list[ScheduleItemMode] | None: List of schedule item modes if successful, None otherwise
        """
        return await self._make_request(
            "GET",
            "schedule-item-modes",
            model_class=ScheduleItemMode,
        )

    async def get_schedule_item_weekdays(self) -> list[ScheduleItemWeekday] | None:
        """Get available schedule item weekdays.

        Returns:
            list[ScheduleItemWeekday] | None: List of schedule item weekdays if successful, None otherwise
        """
        return await self._make_request(
            "GET",
            "schedule-item-weekdays",
            model_class=ScheduleItemWeekday,
        ) 